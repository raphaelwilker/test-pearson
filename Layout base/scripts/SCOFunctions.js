...
function doLMSGetSuspendData()
{
	...
	/* Guarda valores na variável _vlrSuspendData porque getSuspendData é acessível apenas na inicialização do scorm. 
	   Para manipulação dos dados guardado usar variável.*/
